...
private:
  ...
  void sliderCallback(const sensor_msgs::msg::JointState &msg) const
  {
    ...
    arm_command.joint_names = {"base_base_plate_joint", "base_plate_forward_drive_arm_joint", "forward_drive_arm_horizontal_arm_joint"};
    gripper_command.joint_names = {"claw_support_link_gripper_right_joint"};
